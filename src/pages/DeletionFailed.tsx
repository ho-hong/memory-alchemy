...
export default function DeletionFailed() {
  ...
  return (
    <div className="text-[#f9f9f9] antialiased min-h-screen" style={{ background: '#0c0c0c', fontFamily: "'Pretendard', 'Inter', sans-serif" }}>
      {/* TopNavBar */}
      ...
      <main className="min-h-screen pt-32 pb-20 px-6 flex flex-col items-center justify-center">
        <div className="fixed top-1/4 right-0 w-1/3 h-1/2 -z-10 opacity-30 pointer-events-none" style={{ background: '#1a1a1a' }} />

        {/* Give Up Card */}
        {giveUp && (
          <div className="max-w-2xl w-full bg-[#141414] rounded-lg overflow-hidden border border-white/5 relative"
            ...
            <div className="p-10 md:p-16 flex flex-col items-center text-center">
              <div className="mb-8 p-6 rounded-full bg-[#8A2BE2]/10 text-[#8A2BE2] ring-1 ring-[#8A2BE2]/30">
                <span className="material-symbols-outlined text-7xl" style={{ fontVariationSettings: "'wght' 200" }}>sentiment_dissatisfied</span>
              </div>
              ...
              <button
                onClick={() => { sessionStorage.removeItem('retryCount'); navigate('/') }}
        ...
        {/* Failure Card */}
        {!giveUp && <div className="max-w-2xl w-full bg-[#141414] rounded-lg overflow-hidden border border-white/5 relative"
          style={{ boxShadow: '0 40px 80px rgba(0,0,0,0.5)' }}>
          <div className="h-1 w-full bg-[#8A2BE2]" />
          <div className="p-10 md:p-16 flex flex-col items-center text-center">
            {/* Icon */}
            <div className="mb-8 p-6 rounded-full bg-[#8A2BE2]/10 text-[#8A2BE2] ring-1 ring-[#8A2BE2]/30">
              <span className="material-symbols-outlined text-7xl" style={{ fontVariationSettings: "'wght' 200" }}>warning</span>
            </div>
            ...
            <p className="text-gray-400 font-body text-lg leading-relaxed max-w-md mb-12">
              ...
              <span className="opacity-60 text-base">
                잠재의식의 뿌리가 예상보다 깊게 자리하고 있습니다. 신경 정화 후 나중에 다시 시도해주세요.
              </span>
            </p>
          ...
          <div className="absolute bottom-4 right-6 opacity-20 pointer-events-none select-none">
            <span className="text-[0.5rem] font-label tracking-widest text-white">ERROR_CODE: SUB_TRM_0092_NF</span>
          </div>
        </div>}
      ...
      <footer className="fixed bottom-8 left-8 flex gap-8 items-center text-[0.625rem] font-label text-gray-600 uppercase tracking-widest pointer-events-none">
        ...
        <span className="text-[#8A2BE2]/60">Status: Procedure Interrupted</span>
      </footer>
    </div>
  )
}
